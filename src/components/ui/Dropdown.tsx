        ...
        createPortal(
          <>
            ...
            <div
              ref={dropdownRef}
              className={clsx(
                'bg-white shadow-lg rounded-lg border border-[#E5E5E5] p-3 transition-all duration-150 ease-out z-50 max-h-70 thin-scrollbar min-w-40 wrap-break-word dropdown-scroll',
