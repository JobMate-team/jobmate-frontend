...
const QuestionManagementPage = () => {
    ...
    const [editingQuestion, setEditingQuestion] = useState<{ index: number; data: { category: string; type: string; question: string } } | null>(null);
    const [deletingQuestion, setDeletingQuestion] = useState<{ category: string; type: string; question: string } | null>(null);
    ...
    const handleEditQuestion = (originalQuestion: { category: string; type: string; question: string }) => {
